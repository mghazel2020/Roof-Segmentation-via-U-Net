...
4. Train the U-Net instance segmentation model
...
6. To run the ```train.py``` file, change to the directory: ```C:\CV_Exercise_MGhazel_Solutions\code``` and excute the following command:
...
```
(base) C:\CV_Exercise_MGhazel_Solutions\code>cd ..
(base) C:\CV_Exercise_MGhazel_Solutions>cd output
(base) C:\CV_Exercise_MGhazel_Solutions\output>cd training
(base) C:\CV_Exercise_MGhazel_Solutions\output\training>dir
 Volume in drive C is OS
 Volume Serial Number is 34B1-996A
 Directory of C:\CV_Exercise_MGhazel_Solutions\output\training
...
(base) C:\CV_Exercise_MGhazel_Solutions\output\training>
```

* ```C:\CV_Exercise_MGhazel_Solutions\output\trained_model```:
    
```
(base) C:\CV_Exercise_MGhazel_Solutions\output\training>cd ..
(base) C:\CV_Exercise_MGhazel_Solutions\output>cd trained_model
(base) C:\CV_Exercise_MGhazel_Solutions\output\trained_model>dir
 Volume in drive C is OS
 Volume Serial Number is 34B1-996A
 Directory of C:\CV_Exercise_MGhazel_Solutions\output\trained_model
...
(base) C:\CV_Exercise_MGhazel_Solutions\output\trained_model>
```
    
7. To run the ```inference.py``` file, change to the following directory: ```C:\CV_Exercise_MGhazel_Solutions\code``` and excute the following command
...
* To examine the output of the model ```inference```, see the contents of the following output subfolder: ```C:\CV_MGhazel_Solutions\output\inference```:
    
```
(base) C:\CV_Exercise_MGhazel_Solutions\code>cd ..
(base) C:\CV_Exercise_MGhazel_Solutions>cd output
(base) C:\CV_Exercise_MGhazel_Solutions\output>cd inference
(base) C:\CV_Exercise_MGhazel_Solutions\output\inference>dir
 Volume in drive C is OS
 Volume Serial Number is 34B1-996A
 Directory of C:\CV_Exercise_MGhazel_Solutions\output\inference
